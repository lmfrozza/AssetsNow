...
class Cat_Screen():
    ...
    def Main(frame):
        ...
        # Cria o header_label
        header_label = ctk.CTkLabel(header_frame, text="[C.A.T] - Custom Application  Terminal", font=("Arial", 16), text_color="#fff")
        header_label.place(relx=0.5, rely=0.5, anchor='center')  # Posiciona o label no centro do header_frame
        
        #//------------- Changeble Container -------------------\\
        main_frame = ctk.CTkFrame(frame, fg_color="#F1F1F1", width=895, height=490)
